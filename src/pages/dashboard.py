        ...
        with ui.element('div').classes('dashboard-container'):
            with ui.card().classes('w-full p-6 bg-white shadow-lg rounded-xl'):
                ...
                with ui.row().classes('gap-4 mb-6 justify-center'):
                    # ui.button('📤 Upload Document', on_click=lambda: ui.navigate.to('/upload')).classes('bg-green-500 text-white px-4 py-2 rounded-xl')
                    ...
                    ui.button('🔒 Logout', on_click=lambda: ui.navigate.to('/')).classes('bg-gray-500 text-white px-4 py-2 rounded-xl')
